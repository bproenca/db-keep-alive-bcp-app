package com.github.bproenca.nba.infra;
...
@RestController
public class InfraControllerDemo {

	private static final Logger log = LoggerFactory.getLogger(InfraControllerDemo.class);
